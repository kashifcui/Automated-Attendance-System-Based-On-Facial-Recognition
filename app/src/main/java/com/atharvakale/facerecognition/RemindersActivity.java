                        ...
                        androidx.appcompat.app.AlertDialog alertDialog = new androidx.appcompat.app.AlertDialog.Builder(RemindersActivity.this)
                                ...
                                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        editor.commit();
                                        Intent intent = new Intent(RemindersActivity.this, LoginScreen.class);
...
//    }
    ...
    protected void shareApp() {
        ...
        sAIntent.putExtra(Intent.EXTRA_TEXT, "com.atharvakale.facerecognition.Reminder App is a fast and simple app that I use to schedule tasks. Get it from: https://play.google.com/store/apps/details?id=" + getPackageName());
